...
TEST_CASE("Mono resampler sawtooth with 8 samples") {
	...
	SUBCASE("downsample by 3.33333") {
		...
		CHECK(res.process(get_input) == doctest::Approx(0));
		CHECK(res.process(get_input) == doctest::Approx(3.333333));
		CHECK(res.process(get_input) == doctest::Approx(7.25926));
		CHECK(res.process(get_input) == doctest::Approx(2.000000));
		CHECK(res.process(get_input) == doctest::Approx(5.333333));
		CHECK(res.process(get_input) == doctest::Approx(0.370369));
		CHECK(res.process(get_input) == doctest::Approx(4.000000));
		CHECK(res.process(get_input) == doctest::Approx(4.962965));
		CHECK(res.process(get_input) == doctest::Approx(2.66667));
		CHECK(res.process(get_input) == doctest::Approx(6.000000));
		CHECK(res.process(get_input) == doctest::Approx(1.333333));
		CHECK(res.process(get_input) == doctest::Approx(4.66667));
	}
}
